...
function HexBinDensity() {
  ...
  function rollupHexPoints(data) {
    ...
    colorScale = d3.scaleSqrt().domain([minMajority, minMajority*4/5, minMajority*3/5, minMajority*2/5, minMajority*1/5, 0, 
      maxMajority*1/5, maxMajority*2/5, maxMajority*3/5, maxMajority*4/5, maxMajority]).range(d3.schemePuOr[11]);
  ...
  function chart(selection) {
    ...
    legend = g => {
      const wide = 180;
      var cnvs = ramp(d3.schemePuOr[11]);
