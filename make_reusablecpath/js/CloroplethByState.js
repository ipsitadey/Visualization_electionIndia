...
function CloroplethByState() {
  ...
  function update(sel, data) {
    ...
    var groupChartData = [{ "positive": data_var.bjp_negative/data_var.count, "neutral": data_var.bjp_neutral/data_var.count, "negative": data_var.bjp_negative/data_var.count, "party": "BJP" }, 
    { "positive": data_var.congress_positive/data_var.count, "neutral": data_var.congress_neutral/data_var.count, "negative": data_var.congress_negative/data_var.count, "party": "Congress" }];
    var columnsInfo = { "positive": "Positive", "neutral": "Neutral", "negative": "Negative"};

    var barChartConfig = {
        mainDiv: "#tipDiv",
        colorRange: ["#0a6d0a", "#3d3d3d", "#ff3333"],
        data: groupChartData,
